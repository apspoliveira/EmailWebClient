...
Congratulations! Now you have your `asmcrypto.js` and `asmcrypto.js.map` ready to use úÚ£∫
...
My *IntelÅÆ CoreúÙı‚ i7-3770 CPU @ 3.40GHz* typical processing speeds are:
* *Chrome/31.0*
...
[Secure Hash Algorithm](http://en.wikipedia.org/wiki/SHA-1) úÙÚÙ a cryptographic hash function with 160-bit output.
...
[Secure Hash Algorithm](http://en.wikipedia.org/wiki/SHA-2) úÙÚÙ a cryptographic hash functions family.
...
If you like this stuff feel free to donate some funds to `1CiGzP1EFLTftqkfvVtbwvZ9Koiuoc4FSC` úÚ£∫
