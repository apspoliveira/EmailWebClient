...
xc* [shim only](https://raw.githack.com/zloirock/core-js/v2.5.7/client/shim.min.js): Only includes the standard methods.
...
```js
for(var val of 'a€τ¨¤συ½π ®·b'){
  console.log(val); // => 'a', '€τ¨¤συ½π ®·', 'b'
}
...
'€τ¨¤συ½π ®·'.codePointAt(0); // => 134071
String.fromCodePoint(97, 134071, 98); // => 'a€τ¨¤συ½π ®·b'
...
```js
'a€τ¨¤συ½π ®·b'.at(1);        // => '€τ¨¤συ½π ®·'
'a€τ¨¤συ½π ®·b'.at(1).length; // => 2
```
